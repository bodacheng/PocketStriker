...
public class CsvParser2
{
    ...
    class LineStartState : ParserState
    {
    ...
    class ValueStartState : LineStartState
    {
        public override ParserState EndOfLine(ParserContext context)
        {
            context.AddValue();
    ...
    class QuotedValueState : ParserState
    {
        public override ParserState AnyChar(char ch, ParserContext context)
        {
            context.AddChar(ch);
    ...
    class ParserContext
    {
        readonly StringBuilder _currentValue = new StringBuilder();
        readonly List<string[]> _lines = new List<string[]>();
        readonly List<string> _currentLine = new List<string>();
