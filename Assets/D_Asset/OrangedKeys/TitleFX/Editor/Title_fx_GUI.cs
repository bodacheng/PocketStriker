...
public class Title_fx_GUI : ShaderGUI
{
    ...
    void DoMain()
    {
        ...
        //LABELS
        GUILayout.Label("/---------------/ TITLE FX PACK | Shader A /---------------/", EditorStyles.centeredGreyMiniLabel);
        ...
        //Outline Map
        GUILayout.Label("OUTLINE MAP", EditorStyles.helpBox);
        // get properties
