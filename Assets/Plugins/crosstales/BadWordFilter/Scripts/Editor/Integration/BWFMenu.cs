   ...
   public static class BWFMenu
   {
      ...
      private static void ShowInfo()
      {
         EditorUtility.DisplayDialog($"{Constants.ASSET_NAME} - About",
            $"Version: {Constants.ASSET_VERSION}{System.Environment.NewLine}{System.Environment.NewLine}© 2015-2022 by {Util.Constants.ASSET_AUTHOR}{System.Environment.NewLine}{System.Environment.NewLine}{Util.Constants.ASSET_AUTHOR_URL}{System.Environment.NewLine}", "Ok");
      }
   }
}
#endif
