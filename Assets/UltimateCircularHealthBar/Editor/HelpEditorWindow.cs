        ...
        private void OnGUI() {
            using (new GUILayout.HorizontalScope()) {
                ...
                using (new GUILayout.VerticalScope()) {
                    ...
                    GUILayout.Space(10);
                    GUILayout.Label("For instructions on how to use this asset, take a look at the included Readme. I've also set up a fresh Discord server for my assets, so feel free to ask for help/support over there or shoot an email to devorengegames@gmail.com as usual. By the way, I'm looking for people to test my new assets (only the ones that are nearly complete), and I'll be giving out some keys to those who help out!", textStyle);
                    ...
                    using (new GUILayout.HorizontalScope()) {
                        GUILayout.FlexibleSpace();
                        if (GUILayout.Button("Join my Discord", GUILayout.Width(buttonWidth), GUILayout.Height(buttonHeight))) {
